...
![](https://raw.githubusercontent.com/XiangyunHuang/BDAR/master/VBOX4DS/figures/docker-quick-start.png)

直至启动成功

![](https://raw.githubusercontent.com/XiangyunHuang/BDAR/master/VBOX4DS/figures/start_docker.png)


然后打开 putty，选择 docker（之前配置好了IP和端口），

![](https://raw.githubusercontent.com/XiangyunHuang/BDAR/master/VBOX4DS/figures/PuTTY-login-docker.png)
...
```{r fiji,echo=FALSE,fig.width=8,fig.height=6,fig.cap='ggplot2绘图'}
library(maps)
library(mapdata)
library(ggplot2)

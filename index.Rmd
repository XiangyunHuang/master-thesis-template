...
基于 Docker 的工作环境不需要自己安装 R、RStudio、LaTeX 发行版、Git、TeX 包和 R 包以及配置环境，使用介绍请看 <https://github.com/XiangyunHuang/BDAR/blob/master/VBOX4DS/VE4DS.Rmd> 和 <https://github.com/XiangyunHuang/BDAR/blob/master/R2Docker/rocker.Rmd>

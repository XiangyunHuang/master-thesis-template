...
\vspace{0.5cm}
\hspace{2.6cm}\underline{\makebox[0.75\textwidth][c]{its Applications }}
\end{flushleft}
...
\vspace{0.2cm}
\hspace{0.5cm}\makebox[0.20\textwidth][s]{\songti\zihao{4}论文提交日期}:\underline{\makebox[0.22\textwidth][c]{\kaishu 2018年5月12日}}
\hspace{0.1cm}\makebox[0.20\textwidth][s]{\songti\zihao{4}论文答辩日期}:\underline{\makebox[0.22\textwidth][c]{\kaishu 2018年5月12日}}\\
\vspace{0.2cm}
\hspace{0.5cm}\makebox[0.20\textwidth][s]{\songti\zihao{4}学位授予日期}:\underline{\makebox[0.22\textwidth][c]{\kaishu 2018年5月12日}}\\
\vspace{0.2cm}
\end{flushleft}
